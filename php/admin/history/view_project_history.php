<?php
    ...
    */
    ...
    echo '<label>Title: </label><input type="text" class="form-control" id="title" name="title" value="' . utf8_encode($filtered['title']) . '" disabled="disabled">';
    ...
    echo '<label>Address: </label><input type="text" class="form-control" id="address" name="address" value="' . utf8_encode($filtered['address']) . '" disabled="disabled">';
    ...
    echo '<label>Summary: </label><textarea class="form-control" id="summary"  name="summary" rows="10" disabled="disabled">' . utf8_encode($filtered['summary']) . '</textarea>';
